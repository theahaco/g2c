...
export interface Client {
   ...
   */
  verify: ({signature_payload, key_data, sig_data}: {signature_payload: Buffer, key_data: Buffer, sig_data: WebAuthnSigData}, options?: MethodOptions) => Promise<AssembledTransaction<boolean>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
